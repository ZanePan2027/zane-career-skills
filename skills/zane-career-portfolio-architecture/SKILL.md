...
从现有资料推导目标、定位和可展示经历；只补问会改变页面取材的关键缺口，能够完成的部分先做。
...
| 案例深页（按需） | 证据与现场 | Why→What→How、冲突、取舍、协作边界、结果 | 网站摘要的重复扩写 |
...
- 从业务断点命名能力，不从渠道名堆砌标签。
- 新人用课程、社团、实习和早期工作展示岗位所需能力；经验者按真实责任展示。不强编管理升级故事。
...
- 检查知识库是否提供网站没有的判断与现场。
- 检查各载体是否共用同一权威事实源。
- 仅对实际需要的载体检查核心主张如何承接；缺网站或深页不自动降低简历主张，普通简历无需为此建站。
